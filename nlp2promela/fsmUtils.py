...
class FSM:
    ...
    def compareTo(self, other, \
        ...
        # PRINT SUMMARY
        if printit == True:
            printSummaryOfDifference(blue_nodes, blue_transitions, red_nodes, red_transitions, green_nodes,
                                     green_transitions, self.getLabelMap(), other.getLabelMap(), self.removedLines,
                                     comm_transitions, user_call_transitions, rst_transitions, transition_filter)

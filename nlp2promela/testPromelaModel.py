...
def auto_evaluate_DCCP_pml(DCCP_pml):
    auto_evaluate_some_pml(DCCP_pml, add_atomic_propositions_to_DCCP_model, DCCP_props, canonical_DCCP_IO,
                           canonical_DCCP_model, "DCCP")


# Function to do automatic evaluation
def auto_evaluate_TCP_pml(TCP_pml):
    auto_evaluate_some_pml(TCP_pml, add_atomic_propositions_to_TCP_model, TCP_props, canonical_TCP_IO,
                           canonical_TCP_model, "TCP")
